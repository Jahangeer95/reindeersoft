...
export const content: RoboticsAutonomyServiceContentType = {
  description: [
    "A robotic simulation software is a powerful tool that empowers companies to thoroughly test and refine their robotics designs prior to physical implementation. By leveraging a sophisticated physics-based simulator, we can create a realistic virtual environment that accurately replicates robotic movements and behaviors. This enables us to identify potential issues, explore various scenarios, and optimize designs for optimal performance and efficiency.",
