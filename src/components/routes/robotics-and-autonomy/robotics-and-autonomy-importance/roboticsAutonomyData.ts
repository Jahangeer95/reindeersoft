...
export const title: RoboticsAutonomyImportanceTitleType =
  "Why Consider ReindeerSoft for Autonomous Robots Software & Solutions?";
export const contentArray: RoboticsAutonomyImportanceConTentType = [
  "Our team comprises accomplished professionals who have graduated from renowned universities worldwide, equipped with expertise in both autonomous robots software and hardware. From motion planning and real-time safety-compliance software for manipulation and computer vision, our comprehensive skill set ensures that we can design tailored solutions to meet your specific requirements.",
