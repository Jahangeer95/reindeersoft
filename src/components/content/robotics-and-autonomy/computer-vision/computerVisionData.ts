import {
  ComputerVisionContentType,
  ComputerVisionTitleType,
} from "@/types/roboticsAndAutonomy.type";
import ComputerVisionImage from "@/assets/images/robotics-and-autonomy/computer-vision-image.png";

export const title: ComputerVisionTitleType = "Computer Vision";
export const description: ComputerVisionContentType = [
