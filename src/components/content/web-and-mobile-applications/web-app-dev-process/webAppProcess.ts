...
export const description: WebAppDevProcessDescriptionType =
  "Our company specializes in web and app development services that are tailored to meet the unique needs of each of our clients. We offer a full range of development services, from initial concept and planning, to design, development, testing, and deployment. The Process we follow for web development:  ";
