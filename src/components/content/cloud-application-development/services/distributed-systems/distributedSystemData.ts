...
import distributedSystem from "@/assets/images/cloud-application-development/distributed-system.jpg";

export const distributedSystemTitle: CloudAppServiceTitleType =
  "Distributed Systems";
export const distributedSystemContent: CloudAppServiceContent = {
  description:
