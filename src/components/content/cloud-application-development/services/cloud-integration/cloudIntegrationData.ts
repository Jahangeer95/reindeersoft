...
import cloudIntegration from "@/assets/images/cloud-application-development/cloud-integration.jpg";

export const cloudIntegrationTitle: CloudAppServiceTitleType =
  "Cloud Integration";
export const cloudIntegrationContent: CloudAppServiceContent = {
  description: [
