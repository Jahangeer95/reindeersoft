...
export const content: ConsultancyContentType = {
  ...
  list: [
    ...
    {
      title: "Improving Product Release Quality:",
      description:
    ...
    {
      title: "Optimizing QA Processes for Faster Release:",
      description:
    ...
    {
      title: "Test Case Maintenance Challenges:",
      description:
    ...
    {
      title: "Ensuring Complete Traceability:",
      description:
    ...
    {
      title: "Transitioning to Automated Testing:",
      description:
    ...
    {
      title: "Integrating Automated Tests with CI/CD:",
      description:
