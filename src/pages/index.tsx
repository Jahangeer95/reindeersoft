  ...
  return (
    <>
      <MetaInformation
        ...
        description="A dedicated team of professionals committed to delivering exceptional IT services and digital solutions. Experience technological excellence excellence with us."
